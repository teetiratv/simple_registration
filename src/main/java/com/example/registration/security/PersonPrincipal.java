...
public class PersonPrincipal implements UserDetails {
    ...
    public PersonPrincipal(Long id, String username, String password, Collection<? extends GrantedAuthority> authorities) {
        this.id = id;
        this.username = username;
        this.password = password;
    }

    public static PersonPrincipal create(Person person) {
